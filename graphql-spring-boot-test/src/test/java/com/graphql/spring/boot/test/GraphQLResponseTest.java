...
public class GraphQLResponseTest {
  ...
  private static Stream<Arguments> testGetArguments() {
    return Stream.of(
        ...
        Arguments.of("{\"data\": {\"test\": \"2020-02-23\"}}", LocalDate.class,
            LocalDate.parse("2020-02-23")),
        Arguments
            .of("{\"data\": {\"test\": {\"foo\": \"fizzBuzz\", \"bar\": 13.8 }}}", FooBar.class,
  ...
  private static Stream<Arguments> testGetListArguments() {
    return Stream.of(
        ...
        Arguments
            .of("{\"data\": {\"test\": [\"2\", \"1\"]}}", String.class, Arrays.asList("2", "1")),
        ...
        Arguments
            .of("{\"data\":{\"test\":[{\"foo\":\"fizz\",\"bar\":1.23},{\"foo\":\"buzz\",\"bar\":32.12}]}}",
                FooBar.class,
                Arrays.asList(
  ...
  public void testGetAsJavaType() {
    ...
    final JavaType stringList = objectMapper.getTypeFactory()
        .constructCollectionType(List.class, String.class);
    final JavaType listOfStringLists = objectMapper.getTypeFactory()
        .constructCollectionType(List.class,
            stringList);
    // WHEN
    final List<List<String>> actual = createResponse(
        loadClassPathResource(NESTED_LIST_RESPONSE_FILE))
  ...
  void testErrorListAssertion() {
    ...
    assertThat(actual).extracting("actual")
        .isEqualTo(Collections.singletonList(GraphQLTestError.builder()
