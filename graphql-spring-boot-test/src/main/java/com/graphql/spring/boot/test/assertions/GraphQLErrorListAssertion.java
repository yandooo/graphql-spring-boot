    ...
    implements GraphQLResponseAssertion
{
    ...
    public GraphQLErrorListAssertion(final GraphQLResponse graphQLResponse) {
        super(getGraphQLErrors(graphQLResponse), GraphQLErrorListAssertion.class, new ObjectAssertFactory<>());
    ...
    private static List<? extends GraphQLError> getGraphQLErrors(final GraphQLResponse graphQLResponse) {
